...
import svg1 from "../../../public/assets/SVG/hourglass-clock-2.svg";
...
import svg from "../../../public/assets/SVG/hourglass-clock.svg";
...
function Storypreview() {
  ...
  return (
    <>
      <div className="Storypreview-section">
        <div className="storypreview-hero">
          <div className="section">
            <div className="container-preview">
              {/* <button className="icon-times">
                <FontAwesomeIcon icon={faArrowLeft} className="icon-times" />
              </button> */}
              <br />
              ...
              <div className="contanier btn-con">
                <div className="row SDD">
                  <div className="col-md-4 col-sm-3">
                    <button className="save">
                      <img src={svg} alt="Save" />
                      <img src={svg1} alt="Save1" className="svg-white" />
                      Save In History
                    </button>
                  </div>
                  <div className="col-md-4 col-sm-3">
                  ...
                  <div className="col-md-4 col-sm-3">
                    ...
                    <img src={audiowhite} alt="Save1" className="audio-white" />
                      Download As Audio
                    </button>
                  </div>
                </div>
